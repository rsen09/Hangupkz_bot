...
from aiogram.client.session.aiohttp import AiohttpSession # Прокси үшін керек

# 1. ТОКЕН ЖӘНЕ БОТТЫ АНЫҚТАУ
API_TOKEN = '7662747196:AAHR1ilcQgL8dyaLQ5G1d9MJCD9ddXyVx5E'

# PythonAnywhere тегін нұсқасы үшін прокси баптауы
proxy_url = "http://proxy.server:3128"
session = AiohttpSession(proxy=proxy_url)

logging.basicConfig(level=logging.INFO)
# Ботты сессиямен (проксимен) бірге іске қосамыз
